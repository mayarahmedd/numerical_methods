...
import RegularFalse as RegularFalse
import secant as Secant
import FixedPoint as Fixed
...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        MainWindow.setStyleSheet("background-color:qlineargradient(spread:pad, x1:0.078, y1:0.0909091, x2:0.921466, y2:0.96, stop:0 rgba(255, 85, 127, 255), stop:1 rgba(255, 255, 255, 255));")
        ...
        self.tabWidget.setGeometry(QtCore.QRect(0, 400, 1091, 301))
        self.tabWidget.setStyleSheet("border: 0;\n"
                                     ...
                                     "font-size: 14px;\n"
                                     "font-family: \"Lucida Console\", \"Courier New\", monospace;\n"
                                     "background-color:qlineargradient(spread:pad, x1:0.078, y1:0.0909091, x2:0.921466, y2:0.96, stop:0 rgba(255, 85, 127, 255), stop:1 rgba(255, 255, 255, 255));")
